 ...
 *          Exp $
 */
public class TraceDistributionLocal {
    
	
    public TraceDistributionLocal(List values ) {
...
//        initStatistics(values, 0.95);
    ...
    public TraceDistributionLocal(List values,  double ESS) {
        this(values);
        this.ESS = ESS;
    }

	public TraceDistributionLocal(double[] values, double hpdValue) {
